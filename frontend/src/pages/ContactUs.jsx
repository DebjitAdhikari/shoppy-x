          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex items-start group">
                      ...
                      <div className="ml-4">
                        ...
                        <a href={`tel:+91${companyContact[0]?.contactNo}`} className="text-sm text-indigo-600 hover:text-indigo-800 transition-colors">
                          +91 {companyContact[0]?.contactNo || '9876543210'}
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start group">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-600">
                          {companyContact[0]?.address.area || 'Main Street'}<br />
                          {companyContact[0]?.address.city || 'Cityname'}, {companyContact[0]?.address.country || 'Country'}, {companyContact[0]?.address.postalCode || '123456'}
                        </p>
                      </div>
                    </div>
                  ...
                  {/* <div className="mt-10">
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="p-2 bg-indigo-50 rounded-full hover:bg-indigo-100 transition-all">
                ...
                {/* FAQ Section */}
                {/* <div className="mt-8 bg-white rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                  <h3 className="text-xl font-semibold text-gray-900 mb-6">Frequently Asked Questions</h3>
                  
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-medium text-indigo-600">How quickly do you respond to inquiries?</h4>
                      <p className="text-sm text-gray-600 mt-1">We typically respond to all inquiries within 24 hours during business days.</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-medium text-indigo-600">Do you offer support on weekends?</h4>
                      <p className="text-sm text-gray-600 mt-1">Limited support is available on Saturdays. For urgent matters, please call our support line.</p>
                    </div>
                  </div>
                </div> */}
              </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <label htmlFor="privacy-policy" className="ml-2 block text-sm text-gray-600">
                          I agree to the <a href="#" className="text-indigo-600 hover:text-indigo-800">privacy policy</a> and consent to being contacted.
                        </label>
                      </div>
                      ...
                      <div>
                        <button
                          type="submit"
                          className="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center group"
                          disabled={isSending}
                        >
                          {
